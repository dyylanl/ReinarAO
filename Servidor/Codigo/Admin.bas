...
End Sub
Public Sub Silenciar(UserIndex As Integer, ByVal Minutos As Long)

    UserList(UserIndex).Counters.TiempoSilenc = 60 * Minutos
    UserList(UserIndex).flags.Silenciado = 1
    UserList(UserIndex).Counters.PenaSilenc = Timer
