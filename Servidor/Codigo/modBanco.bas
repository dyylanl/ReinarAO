...
End Sub
Sub IniciarViaje(UserIndex As Integer)

    Call SendData(ToIndex, UserIndex, 0, "INITVIAJE")
    UserList(UserIndex).flags.Comerciando = True

End Sub
Sub IniciarConstruccion(UserIndex As Integer)

    Call SendData(ToIndex, UserIndex, 0, "INITCONST")
    UserList(UserIndex).flags.Comerciando = True
