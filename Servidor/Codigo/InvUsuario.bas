...
Sub QuitarBebida(UserIndex As Integer, ByVal Slot As Byte)
    ...
    If UserList(UserIndex).Invent.Object(Slot).Amount <= 0 Then
        ...
        Call SendData(ToPCAreaButIndex, UserIndex, UserList(UserIndex).pos.Map, "TW" & "46" & "," & UserList(UserIndex).pos.X & "," & UserList(UserIndex).pos.Y)
...
Sub QuitarComida(UserIndex As Integer, ByVal Slot As Byte)
    ...
    If UserList(UserIndex).Invent.Object(Slot).Amount <= 0 Then
        ...
        Call SendData(ToPCAreaButIndex, UserIndex, UserList(UserIndex).pos.Map, "TW" & "7" & "," & UserList(UserIndex).pos.X & "," & UserList(UserIndex).pos.Y)
...
Sub QuitarPocionMana(UserIndex As Integer, ByVal Slot As Byte)
    ...
    Else
        Call SendData(ToIndex, UserIndex, 0, "7I" & THeDEnCripTe(Slot & "," & UserList(UserIndex).Stats.MinMAN, "mHlzsJxIQi"))
        Call SendData(ToPCAreaButIndex, UserIndex, UserList(UserIndex).pos.Map, "TW" & "46" & "," & UserList(UserIndex).pos.X & "," & UserList(UserIndex).pos.Y)
...
Sub EraseObj(ByVal sndRoute As Byte, ByVal sndIndex As Integer, ByVal sndMap As Integer, ByVal Num As Integer, Map As Integer, X As Integer, Y As Integer)
    ...
    If MapData(Map, X, Y).OBJInfo.Amount <= 0 Then
        ...
        Call SendData(sndRoute, sndIndex, sndMap, "BO" & DesteEncripTE(X & "," & Y))
    End If
...
Sub MakeObj(ByVal sndRoute As Byte, ByVal sndIndex As Integer, ByVal sndMap As Integer, Obj As Obj, Map As Integer, X As Integer, Y As Integer)
    ...
    Call SendData(sndRoute, sndIndex, sndMap, "HO" & DesteEncripTE(ObjData(Obj.OBJIndex).GrhIndex & "," & X & "," & Y))
...
Sub Desequipar(UserIndex As Integer, ByVal Slot As Byte)
    ...
    Select Case Obj.ObjType
        ...
        Case OBJTYPE_ALAS
            ...
            Call ChangeUserChar(ToMap, 0, UserList(UserIndex).pos.Map, UserIndex, UserList(UserIndex).Char.Body, UserList(UserIndex).Char.Head, UserList(UserIndex).Char.Heading, UserList(UserIndex).Char.WeaponAnim, UserList(UserIndex).Char.ShieldAnim, UserList(UserIndex).Char.CascoAnim, NingunAlas)
...
Sub EquiparInvItem(UserIndex As Integer, Slot As Byte)
    ...
    Select Case Obj.ObjType
        ...
        Case OBJTYPE_ALAS
            If ClasePuedeUsarItem(UserIndex, OBJIndex) And _
               FaccionPuedeUsarItem(UserIndex, OBJIndex) Then
                ...
                If UserList(UserIndex).Invent.AlaEqpObjIndex > 0 Then Call Desequipar(UserIndex, UserList(UserIndex).Invent.AlaEqpSlot)
        ...
        Case OBJTYPE_WEAPON
            ...
            Call SendData(ToPCArea, UserIndex, UserList(UserIndex).pos.Map, "TW" & SOUND_SACARARMA & "," & UserList(UserIndex).pos.X & "," & UserList(UserIndex).pos.Y)
    ...
    Select Case Obj.ObjType
        ...
        Case OBJTYPE_INSTRUMENTOS
            If UserList(UserIndex).flags.Muerto Then
                ...
                Exit Sub
            End If
            Call SendData(ToPCArea, UserIndex, UserList(UserIndex).pos.Map, "TW" & Obj.Snd1 & "," & UserList(UserIndex).pos.X & "," & UserList(UserIndex).pos.Y)
        ...
        Case OBJTYPE_BARCOS
            ...
            End If
        Case OBJTYPE_Manual
            Call SendData(ToIndex, UserIndex, 0, "MANUAL")
...
Sub EnviarObjConstruibles(UserIndex As Integer)
    Dim i As Integer, cad As String, Coste As Long
...
Sub TirarTodo(UserIndex As Integer)
    ...
    If MapInfo(UserList(UserIndex).pos.Map).SeCaenItems = 1 Then Exit Sub
...
Sub TirarTodosLosItems(UserIndex As Integer)
    ...
    If UserList(UserIndex).pos.Map = 22 Then Exit Sub
    If UserList(UserIndex).pos.Map = 7 Then Exit Sub
    If UserList(UserIndex).pos.Map = 3 Then Exit Sub
    If UserList(UserIndex).pos.Map = 4 Then Exit Sub
    If UserList(UserIndex).pos.Map = 5 Then Exit Sub
    ...
    If UserList(UserIndex).pos.Map = 193 Then Exit Sub
    If UserList(UserIndex).pos.Map = 194 Then Exit Sub
    If UserList(UserIndex).pos.Map = 195 Then Exit Sub
    If UserList(UserIndex).pos.Map = 196 Then Exit Sub
    If UserList(UserIndex).pos.Map = 197 Then Exit Sub
    If UserList(UserIndex).pos.Map = 198 Then Exit Sub
    If UserList(UserIndex).pos.Map = 199 Then Exit Sub
    If UserList(UserIndex).pos.Map = 200 Then Exit Sub
    If UserList(UserIndex).pos.Map = 60 Then Exit Sub
    If UserList(UserIndex).pos.Map = 79 Then Exit Sub
    If UserList(UserIndex).pos.Map = 202 Then Exit Sub
    If UserList(UserIndex).pos.Map = 203 Then Exit Sub
    If UserList(UserIndex).pos.Map = 204 Then Exit Sub
    ...
    If TieneObjetos(928, 1, UserIndex) = True And UserList(UserIndex).pos.Map <> 211 Then
        Call QuitarObjetos(928, 1, UserIndex)
        'particula de que quemo sacri!!
        Exit Sub
    End If
...
Sub TirarTodosLosItemsNoNewbies(UserIndex As Integer)
    ...
    If MapData(UserList(UserIndex).pos.Map, UserList(UserIndex).pos.X, UserList(UserIndex).pos.Y).trigger = 7 Then Exit Sub
