...
Begin VB.Form frmCanjes 
   ...
   Begin VB.ListBox List1 
      ...
      ForeColor       =   &H00FFFFFF&
      Height          =   6300
      ItemData        =   "Form1.frx":21EBA
      Left            =   1680
      List            =   "Form1.frx":21EBC
      TabIndex        =   0
      Top             =   720
      Width           =   3135
   End
   ...
   Begin VB.Label Label1 
      ...
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "Lista Completa de Items de Canjeo de Lhirius AO"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   0
...
If List1.Text = "Daga Naturalista" Then Call SendData("/CANJEO T6")
If List1.Text = "Baculo de los dioses" Then Call SendData("/CANJEO T7")
...
If List1.Text = "Armadura Soberana Blanca (Bajos)" Then Call SendData("/CANJEO T17")
If List1.Text = "Armadura Soberana Blanca (Altos)" Then Call SendData("/CANJEO T18")
...
If List1.Text = "Espada Clerical" Then Call SendData("/CANJEO T22")
...
If List1.Text = "Arco Celestial" Then Call SendData("/CANJEO T34")
If List1.Text = "Pendiente del Sacrificio" Then Call SendData("/CANJEO T35")
End Sub
