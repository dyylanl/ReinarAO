...
MiMensaje(1).Text = ""
    ...
    Label2.Visible = True
Else
    Call SendData("DEMSG" & MiMensaje(0).Text & " [" & frmMain.Label8 & "]" & Chr(176) & "Fecha: " & Date & " || Hora: " & Time & " || Mensaje: " & MiMensaje(1).Text)
...
Me.Picture = LoadPicture(App.Path & "\RECURSOS\INTERFACES\ForoMensajes.gif")
