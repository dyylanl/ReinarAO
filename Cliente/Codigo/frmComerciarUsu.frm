...
Private Sub Form_Load()
    ...
    Me.Picture = LoadPicture(App.Path & "\RECURSOS\INTERFACES\ComerciarUsu.gif")
...
Private Sub list1_Click()
    Call DrawGrhtoHdc(Picture1, UserInventory(List1.ListIndex + 1).GrhIndex, 0, 0)
End Sub
Private Sub List2_Click()

    If List2.ListIndex >= 0 Then
        Call DrawGrhtoHdc(Picture1, OtroInventario(List2.ListIndex + 1).GrhIndex, 0, 0)
