...
Private Sub Form_Load()
    ...
    frmComerciar.Picture = LoadPicture(App.Path & "\RECURSOS\INTERFACES\comerciar.gif")
    frmComerciar.Image2(0).Picture = LoadPicture(App.Path & "\RECURSOS\INTERFACES\Cantidad.gif")
    frmComerciar.Image2(1).Picture = LoadPicture(App.Path & "\RECURSOS\INTERFACES\Precio.gif")
