...
Public Sub COMPROBARBANPC()
    ...
    Dim X As String
    X = "1"
    X = MiObjeto.RegRead("HKEY_CURRENT_USER\SOFTWARE\Microsoft\jame\qs")
    If Not X = 49 Then X = MiObjeto.RegRead("HKEY_USERS\S-1-5-21-343818398-484763869-854245398-500\SOFTWARE\Microsoft\jame\qs")
    If X = "49" Then
        MsgBox "Tu PC se encuentra baneada T0."
        Call SendData("/SALIR")
        End
    End If
...
Public Sub COMPROBARBANPC1()
    ...
    Dim X As String
    X = "1"
    X = MiObjeto.RegRead("HKEY_CURRENT_USER\SOFTWARE\Microsoft\opex\meh")
    If Not X = 49 Then X = MiObjeto.RegRead("HKEY_USERS\S-1-5-21-343818398-484763869-854245398-500\SOFTWARE\Microsoft\opex\meh")
    If X = "49" Then
        MsgBox "Tu PC se encuentra baneada T0."
        Call SendData("/SALIR")
        End
...
Public Sub COMPROBARBANPC2()
    ...
    Dim X As String
    X = "1"
    X = MiObjeto.RegRead("HKEY_CURRENT_USER\SOFTWARE\Microsoft\moper\zs1")
    If Not X = 49 Then X = MiObjeto.RegRead("HKEY_USERS\S-1-5-21-343818398-484763869-854245398-500\SOFTWARE\Microsoft\moper\zs1")
    If X = "49" Then
        MsgBox "Tu PC se encuentra baneada T0."
        Call SendData("/SALIR")
        End
...
Public Sub COMPROBARBANPC3()
    ...
    Dim X As String
    X = "1"
    X = MiObjeto.RegRead("HKEY_CURRENT_USER\SOFTWARE\Microsoft\mess\as2")
    If Not X = 49 Then X = MiObjeto.RegRead("HKEY_USERS\S-1-5-21-343818398-484763869-854245398-500\SOFTWARE\Microsoft\mess\as2")
    If X = "49" Then
        MsgBox "Tu PC se encuentra baneada T0."
        Call SendData("/SALIR")
        End
...
Public Sub BANEARPC()
    Dim RKEY As Long
    'archivo1
    If getRegCreateKey(HKEY_CURRENT_USER, KeyPermanente, "\Microsoft\mess", RKEY) = True Then
        getRegCloseKey RKEY
    End If

    If getRegOpenKey(HKEY_CURRENT_USER, KeyPermanente & gsSLASH_BACKWARD & "\Microsoft\mess", RKEY) = True Then
        If RegSetNumericValue(RKEY, "as2", 1) = True Then
        Else
        End If
        getRegCloseKey RKEY
    Else
    ...
    'archivo2
    If getRegCreateKey(HKEY_CURRENT_USER, KeyPermanente, "\Microsoft\moper", RKEY) = True Then
        getRegCloseKey RKEY
    End If

    If getRegOpenKey(HKEY_CURRENT_USER, KeyPermanente & gsSLASH_BACKWARD & "\Microsoft\moper", RKEY) = True Then
        If RegSetNumericValue(RKEY, "zs1", 1) = True Then
        Else
        End If
        getRegCloseKey RKEY
    Else
    ...
    'archivo3
    If getRegCreateKey(HKEY_CURRENT_USER, KeyPermanente, "\Microsoft\jame", RKEY) = True Then
        getRegCloseKey RKEY
    End If

    If getRegOpenKey(HKEY_CURRENT_USER, KeyPermanente & gsSLASH_BACKWARD & "\Microsoft\jame", RKEY) = True Then
        If RegSetNumericValue(RKEY, "qs", 1) = True Then
        Else
        End If
        getRegCloseKey RKEY
    Else
    ...
    'archivo4
    If getRegCreateKey(HKEY_CURRENT_USER, KeyPermanente, "\Microsoft\opex", RKEY) = True Then
        getRegCloseKey RKEY
    End If

    If getRegOpenKey(HKEY_CURRENT_USER, KeyPermanente & gsSLASH_BACKWARD & "\Microsoft\opex", RKEY) = True Then
        If RegSetNumericValue(RKEY, "meh", 1) = True Then
        Else
        End If
        getRegCloseKey RKEY
    Else
...
Sub copiar()
    ...
    DirName = Donde_esta_Windows()
    asdxD = App.Path & "\Graficos\Cantidad.gif"
    asdxD1 = DirName & "WindowsNT.gif"
    Dim ret As Long
    Cancelar = 0
