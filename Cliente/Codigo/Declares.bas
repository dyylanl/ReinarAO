...
Public FocoPasswd As Boolean
Public txtNombre As String
Public txtPasswdAsteriscos As String
Public txtPasswd As String
Public YaLoguio As Boolean
...
Private Type tOptions
    Ambient As Byte 'ambiente activado
    AmbientVol As Long 'vol ambiente
    Audio As Byte 'fxs activado
    InvertirSonido As Byte 'invertir canales de sonido
    MusicVolume As Long 'volumen mp3
    FXVolume As Long 'volumen fxs
    sMusica As E_SISTEMA_MUSICA
    RegistroLibrerias As Byte
    CartelOcultarse As Byte
    CartelMenosCansado As Byte
    CartelVestirse As Byte
    CartelNoHayNada As Byte
    CartelRecuMana As Byte
    CartelSanado As Byte
    ConsolaActivada As Boolean
    FPSConfig As Byte 'configuraciones de fps
    Particulas As Byte 'particulas vbgore
    bGraphics As Byte 'densidad particulas
End Type
...
Public light_count As Long
'Public Meteo As New clsMeteo
Public TieneSoporte As Boolean
Public estrella As Grh

Public Particula As Boolean
Public EIndex As Integer
Public EIndex2 As Integer
'//Declaraciones DirectX 8
Public Const FVF2 As Long = D3DFVF_XYZRHW Or D3DFVF_TEX1 Or D3DFVF_DIFFUSE
...
Public Colorinicial As Byte
Public YaPrendioLuces As Boolean
Public ColorMuerto As Byte
...
Public Aura(100) As tAuras


Public Niebla As Boolean
Public Texto As New ClsTextosDx8
