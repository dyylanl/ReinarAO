...
Public Sub parseCharInfo(ByVal Rdata As String)
    ...
    Select Case Val(ReadField(14, Rdata, 44))
        ...
        Case 1
            ...
            faccion.Caption = "Faccion: Alianza del Lhirius"
        Case 2
            faccion.ForeColor = vbRed
            faccion.Caption = "Faccion: Ejército de Horda infernal"
    End Select
...
Private Sub Form_Load()
    ...
    Me.Picture = LoadPicture(App.Path & "\RECURSOS\INTERFACES\CharInfo.gif")
    Echar.Picture = LoadPicture(App.Path & "\RECURSOS\INTERFACES\echar.gif")
    desc.Picture = LoadPicture(App.Path & "\RECURSOS\INTERFACES\desc.gif")
    Aceptar.Picture = LoadPicture(App.Path & "\RECURSOS\INTERFACES\aceptar.gif")
    Rechazar.Picture = LoadPicture(App.Path & "\RECURSOS\INTERFACES\rechazar.gif")
