...
Sub Engine_Init_ParticleEngine()
        ...
        For i = 1 To UBound(ParticleTexture())
                ...
                Set ParticleTexture(i) = D3DX.CreateTextureFromFileEx(D3DDevice, App.Path & "\Graficos\Grh\" & "p" & i & ".png", D3DX_DEFAULT, D3DX_DEFAULT, D3DX_DEFAULT, 0, D3DFMT_UNKNOWN, D3DPOOL_MANAGED, D3DX_FILTER_NONE, D3DX_FILTER_NONE, &HFF000000, ByVal 0, ByVal 0)

        Next i
        
        For i = 1 To 4
            If Not SangreTexture(i) Is Nothing Then Set SangreTexture(i) = Nothing
            Set SangreTexture(i) = D3DX.CreateTextureFromFileEx(D3DDevice, App.Path & "\Graficos\Grh\" & "2500" & i & ".png", D3DX_DEFAULT, D3DX_DEFAULT, D3DX_DEFAULT, 0, D3DFMT_UNKNOWN, D3DPOOL_MANAGED, D3DX_FILTER_NONE, D3DX_FILTER_NONE, &HFF000000, ByVal 0, ByVal 0)
        Next i
End Sub
                ...
                If effect(EffectIndex).GoToX <> effect(EffectIndex).X Or effect(EffectIndex).GoToY <> effect(EffectIndex).Y Then
                        ...
                        If effect(EffectIndex).X = effect(EffectIndex).GoToX Then
                            ...
                            If effect(EffectIndex).Progression <> 0 Then
                                ...
                                If effect(EffectIndex).EffectNum = EffectNum_Necro Then
